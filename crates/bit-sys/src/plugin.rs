...
use bit_types::error::{InstanceError, PluginError, WasmEdgeError};
...
impl PluginManager {
    ...
    /// # Error
    ///
    /// * If the path contains invalid characters, then an [WasmEdgeError::FoundNulByte](bit_types::error::WasmEdgeError::FoundNulByte) error is returned.
    ...
    /// # Error
    ///
    /// If not found the plugin, then return [PluginError::NotFound](bit_types::error::PluginError::NotFound) error.
...
impl Plugin {
    ...
    /// # Error
    ///
    /// If failed to return the plugin module instance, then return [PluginError::Create](bit_types::error::PluginError::Create) error.
